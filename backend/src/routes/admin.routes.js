...
adminRoutes.put("/pending-user-by-id/:id", authMiddleware, checkAdmin, PendingUserById);
...
adminRoutes.get("/get-users-approved", authMiddleware, checkAdmin, getAllApprovedUsers);
