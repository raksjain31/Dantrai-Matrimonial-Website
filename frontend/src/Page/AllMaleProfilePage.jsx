...
const AllMaleProfilePage = () => {
    const { authUser } = useAuthStore();
    const { gendertype } = useParams();

    const { getMaleProfile, profiles, isProfileLoading } = useProfileStore();
    ...
    return (
        <div className='min-h-screen flex flex-col items-center mt-14 px-4' >
            ...
            <h1 className="text-4xl font-extrabold z-10 text-center">
                ...
                Search  <span className="text-purple-800  "> Male Biodata</span>
...
export default AllMaleProfilePage