...
const EditProfileForm = () => {
    ...
    // (`/profile/get-profile/${id}`) // your API endpoint
    //     .then((res) => res.json())
    //     .then((data) => {
    //         // Pre-fill the form
    //         console.log('Profile Data by id:::', data);
    //         reset({
    //             name: data.name,
    //             email: data.email,
    ...
    React.useEffect(() => {
        if (profile) {
            ...
            reset({
                ...
                aboutmycareer: profile.aboutmycareer,
                father: profile.father,
                mother: profile.mother,
                noOfBrothers: profile.noOfBrothers,
                noOfsisters: profile.noOfsisters,
                noOfMarriedBrothers: profile.noOfMarriedBrothers,
                noOfMarriedSisters: profile.noOfMarriedSisters,
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const res = await axiosInstance.put(`/profile/update-profile/${id}`, formData);
